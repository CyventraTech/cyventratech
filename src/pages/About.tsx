    ...
    <main className="bg-black text-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex flex-col justify-center px-6 md:px-16 pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto w-full">
          ...
          {/* Main headline — staggered colors */}
          <h1 className="font-black leading-[0.92] tracking-tight mb-8">
            <span className="block text-[11vw] md:text-[9vw] text-white">we didn't</span>
            <span className="block text-[11vw] md:text-[9vw] text-red-600">start with</span>
            <span className="block text-[11vw] md:text-[9vw] text-blue-500">money.</span>
            <span className="block text-[7vw] md:text-[5vw] text-white/60 mt-2">we started with</span>
            <span className="block text-[7vw] md:text-[5vw] text-white italic">belief.</span>
          </h1>
          ...
          <p className="text-white/50 text-base md:text-lg max-w-xl leading-relaxed mt-6">
            ...
            <span className="text-white font-medium"> That's how CYVENTRA was born.</span>
          </p>
